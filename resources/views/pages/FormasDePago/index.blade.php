...
@include('flash::message')
        ...
        <div class="col-md-12 col-sm-12">
            <div class="portlet box main-color">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cogs"></i>Formas de Pago </div>
                    <div class="actions">
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column text-center" id="tabla">
                        ...
                        <tbody>
                            @foreach($FormasDePago as $FormaDePago)
                                <tr id="{{$FormaDePago->Codigo}}" class="item{{$FormaDePago->Codigo}}">
                                    ...
                                    @if(App\Librerias\UtilidadesClass::ValidarAcceso($forma,"Actualizar") || App\Librerias\UtilidadesClass::ValidarAcceso($forma,"Eliminar"))
                                        ...
                                        @if(App\Librerias\UtilidadesClass::ValidarAcceso($forma,"Actualizar"))
                                            <a href='' id='lkEdit' name='lkEdit' class='btn btn-icon-only yellow-gold' data-toggle='modal' data-codigo='{{$FormaDePago->Codigo}}' data-descripcion='{{$FormaDePago->Descripcion}}'>
                                                <i class='fa fa-edit'></i>
                                            </a>
                                        @endif
                                        @if(App\Librerias\UtilidadesClass::ValidarAcceso($forma,"Eliminar"))
                                            <a href='' id='lkDelete' name='lkDelete' class='btn btn-icon-only red' data-toggle='modal' data-codigo='{{$FormaDePago->Codigo}}'>
    ...
    <script src="{{ asset('js/FormasDePago/index.js') }}" type="text/javascript"></script>
@endsection