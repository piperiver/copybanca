            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div id="divParrafo">
                            <p style="margin: -5px 0px 5px 0px;" class="text-center uppercase"><strong>Es posible que alguna obligacion este repetida, toca/click para eliminar y da click en siguiente.</strong></p>
                        </div>
                        <div class="table-responsive div-obligaciones">
                            ...
                            <table class="table table-hover text-center listaSelObligaciones">
                                ...
                                <tbody>
                                    ...
                                    <tr class="pointer obligacion" data-obligacion="{{ $obligacion->id }}">
                                        <td>                            
                    ...
                    <div class="modal-footer" id="divFooter">
                        ...
                        <button type="button" class="btn" id="Anterior" data-url="{{ config('constantes.RUTA') }}Consultas">Cancelar</button>
                        <button type="button" style="border-radius: 4px!important;border:1px solid #000!important;" class="btn btnPrueba lockClicks" id="sgtProceso" data-url="{{ config('constantes.RUTA') }}GestionObligaciones/procesarObligaciones" data-redireccion="{{ config('constantes.RUTA') }}Valoraciones/{{ $idValoracion }}">Siguiente</button>                        
                    </div>
                </div>
            </div>
