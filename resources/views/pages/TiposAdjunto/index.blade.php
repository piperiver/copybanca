...
@include('flash::message')
        ...
        <div class="col-md-12 col-sm-12">
            <div class="portlet box main-color">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cogs"></i>Tipos de Adjuntos </div>
                    <div class="actions">
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column text-center" id="tabla">
                        ...
                        <tbody>
                            @foreach($TiposAdjunto as $TipoAdjunto)
                                <tr id="{{$TipoAdjunto->Codigo}}" class="item{{$TipoAdjunto->Codigo}}">
                                    ...
                                    @if(App\Librerias\UtilidadesClass::ValidarAcceso($forma,"Actualizar") || App\Librerias\UtilidadesClass::ValidarAcceso($forma,"Eliminar"))
                                        ...
                                        @if(App\Librerias\UtilidadesClass::ValidarAcceso($forma,"Actualizar"))
                                            <a href='' id='lkEdit' name='lkEdit' class='btn btn-icon-only yellow-gold' data-toggle='modal' data-codigo='{{$TipoAdjunto->Codigo}}' data-descripcion='{{$TipoAdjunto->Descripcion}}'>
                                                <i class='fa fa-edit'></i>
                                            </a>
                                        @endif
                                        @if(App\Librerias\UtilidadesClass::ValidarAcceso($forma,"Eliminar"))
                                            <a href='' id='lkDelete' name='lkDelete' class='btn btn-icon-only red' data-toggle='modal' data-codigo='{{$TipoAdjunto->Codigo}}'>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Tipo de Adjunto</h4>
                </div>
                <div class="modal-body">
                    <form class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="txCodigo" name="txCodigo" maxlength="3" style="text-transform: uppercase;" class="form-control input-circle" placeholder="Defina Código de Tipo de Adjunto.">
                            </div>
                        </div>
                    </form>
                    <form class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="txDescripcion" name="txDescripcion" maxlength="255" class="form-control input-circle" placeholder="Defina Descripción de Tipo de Adjunto.">
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <script src="{{ asset('js/TiposAdjunto/index.js') }}" type="text/javascript"></script>
@endsection
