...
$(document).on('click', '#lkEdit', function()
{
    ...
    $('#txRedireccionamiento').val($(this).data('redireccionamiento'));
...
$('#btGuardar').click(function()
{
    ...
    var Redireccionamiento =  $('#txRedireccionamiento').val();
    var ruta = "addPerfil";
    ...
    $.ajax({
        ...
        data: {
            ...
            'Estado': Estado,
            'url_redireccionamiento': Redireccionamiento
        },
