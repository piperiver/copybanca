...
$(document).ready(function(){
    ...
    (function( bootstro, $, undefined ) {
        ...
        var defaults = {
            nextButtonText : '&raquo;&raquo;', //will be wrapped with button as below
            //nextButton : '<button class="btn btn-primary btn-xs bootstro-next-btn">Siguiente &raquo;</button>',
            prevButtonText : '&laquo;&laquo;',
            //prevButton : '<button class="btn btn-primary btn-xs bootstro-prev-btn">&laquo; Anterior</button>',
            finishButtonText : '<i class="icon-ok"></i> Finalizar',
            //finishButton : '<button class="btn btn-xs btn-success bootstro-finish-btn"><i class="icon-ok"></i> Finalizar</button>',
